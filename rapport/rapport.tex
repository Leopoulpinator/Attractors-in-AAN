...
\begin{titlepage}
   ...
   \vspace{1cm}
      ...
      Laboratoire CRIStAL, CNRS de Lille\\
...
\begin{itemize}
	...
	\item \textbf{check(k) :}\\
		...
		satisfiable.\\
		\textcolor{magenta}{Dans notre exemple, le coup de caisse qu'on a choisi fait peut-être avancer la résolution, mais ne l'a pas achevé.}\\
\end{itemize}
...
\newpage
\section{Annexes}
Mon stage a eu lieu dans le laboratoire CRIStAL (Villeneuve-d'Ascq, 59655) situé dans la cité scientifique de Lille. Ce laboratoire est rattaché à l'université et au CNRS de Lille.\\ \\
...
Voici l'organisation de mon GitHub :\\
\begin{itemize}
