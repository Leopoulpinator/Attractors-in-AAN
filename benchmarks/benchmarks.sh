  ...
  do
    ...
    do
      ...
      do
        ...
        Command="clingo 0 --quiet=2 --time-limit=${TimeLimit} --const n=${CurSize} --const filtering=${CurFilter} --const write_nbr_solutions=${CurGatherFile} ${AdditionalParameters} ../versions/v3_only_for_synch_semantic/attractor_for_synch.lp ${ModelsFolder}${CurModel}"
