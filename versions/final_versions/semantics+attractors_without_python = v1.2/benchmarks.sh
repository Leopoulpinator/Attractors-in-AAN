...
MoveFolder="benchmarks_${MoveFolder//:/-}"
  ...
  do
    ...
    do
      ...
      do
        ...
        Command="clingo 0 --quiet=2 --time-limit=${TimeLimit} --const n=${CurSize} --const filtering=${CurFilter} --const write_nbr_solutions=${CurGatherFile} ${AdditionalParameters} ${CurSemantics}.lp attractors.lp ../../../resources/filtering-attractors.lp ${ModelsFolder}${CurModel}"
